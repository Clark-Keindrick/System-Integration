<?php
    ...
    $branch = 'CORDOVA';
    $total_del_items = total_deleted_items($branch);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <link rel="stylesheet" href="css/deleted_item.css">
...
<body>
  <div class="header">
      <div class="text">CORDOVA Deleted Items</div>
  ...
  <div class="row page-path">
    ...
    <div class="btns-switch">
        <div></div>
        <button type="button" class="btn btn-lg btn-danger btn-switch" onclick="location.href='LLCdeleted_items.php'"><i class='bx bx-arrow-back' undefined></i>Cordova Branch</button>
    </div>

  <section class="home-section">
        <div class="inv_header bg-warning text-dark">
            ...
            <h3 class="tot_item_label">Total Deleted Items: <?php echo $total_del_items; ?></h3>
        </div>

        <div class="item-list">
            <?php deleted_inventory_item($userID, $branch); ?>
        </div>
  </section>
