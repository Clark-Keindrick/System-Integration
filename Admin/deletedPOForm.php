...
<head>
  ...
  <link rel="stylesheet" href="css/deletedPO.css">
   ...
   <div class="row page-path">
        <nav aria-label="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="dashboard.php"> <i class='bx bxs-home' style='color:#36a7ff'  ></i></a></li>
                <li class="breadcrumb-item active" aria-current="page">DELETED P.O Form</li>
            </ol>
        </nav>
    </div>
    <main class="home-section">
        <h1 class="ribbon">
            <strong class="ribbon-content">P.O Form</strong>
        </h1>

        <div class="deleted_PO table-responsive-md">
            <?php  Deleted_PO_Form_table(); ?>
        </div>
