...
<body>
  <div class="header">
      <div class="text">LLC Deleted Items</div>
  ...
  <div class="row page-path">
    ...
    <div class="btns-switch">
        <div></div>
        <button type="button" class="btn btn-lg btn-warning btn-switch" onclick="location.href='Cordova_Del_Items.php'"><i class='bx bx-arrow-back' undefined></i>Cordova Branch</button>
    </div>
