...
<html lang="en">
<head>
  <title>Lapu-Lapu Inventory</title>
  <!-- Link Styles -->
  ...
  <?php include("sidebar.php");?>
   ...
   <div class="row page-path">
    ...
    <div class="btns-switch">
        <button type="button" class="btn btn-lg btn-warning btn-add" onclick="location.href='add_inventory.php'"><i class='bx bxs-cart-add' undefined ></i>Add New Item</button>
        <button type="button" class="btn btn-lg btn-secondary btn-switch" onclick="location.href='CordovaInventory.php'"><i class='bx bx-arrow-back' style='color:#ffffff'></i>Cordova Branch</button>
    </div>
